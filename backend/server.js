...
const DEPLOY_CALLBACK_URL = process.env.RENDER_EXTERNAL_URL ? `${process.env.RENDER_EXTERNAL_URL}/api/auth/naver/callback` : `${PUBLIC_BACKEND_URL}/api/auth/naver/callback`;
...
app.get("/api/auth/naver/callback", async (req, res) => {
  ...
  try {
    ...
    saveStore(store);
    setSessionCookie(req, res, signUser(user));
    res.redirect(withQuery(returnTo, "login", "ok"));
  } catch (err) {
